  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(/outlets_safety.jpg)',
      ...
      <div className="relative z-[6] h-full flex flex-col justify-center px-[6vw]">
        ...
        <div ref={headlineRef} className="mb-8">
          <h2 className="font-display font-bold text-[#F6F7F9] uppercase leading-[0.92] tracking-tight">
            <span className="headline-line block text-[clamp(2.5rem,7vw,6rem)]">Safety</span>
            <span className="headline-line block text-[clamp(2.5rem,7vw,6rem)]">First</span>
          </h2>
        </div>
        ...
        <div ref={bodyRef} className="max-w-sm">
          <p className="text-[#A9AFB8] text-base leading-relaxed mb-6">
            Arc-fault, surge protection, and grounding done right—because prevention is the best repair.
          </p>
