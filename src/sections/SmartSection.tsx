  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(/smart_switch_wall.jpg)',
      ...
      <div className="relative z-[6] h-full flex flex-col items-center justify-center text-center px-[6vw]">
        ...
        <div ref={headlineRef} className="mb-8">
          <h2 className="font-display font-bold text-[#F6F7F9] uppercase leading-[0.92] tracking-tight">
            <span className="headline-line block text-[clamp(3rem,10vw,8rem)]">Smart</span>
            <span className="headline-line block text-[clamp(3rem,10vw,8rem)]">Living</span>
          </h2>
        </div>
        ...
        >
          Control lighting, schedules, and scenes from anywhere—simple, intuitive, reliable.
        </p>
      </div>
