  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(/junction_box_cables.jpg)',
      ...
      <div
        ref={overlayRef}
        className="absolute right-0 top-0 w-[55vw] h-full z-[2] bg-right-gradient"
      />

      {/* Vertical Label (Left) */}
      <div
        ref={verticalLabelRef}
        className="absolute left-[3.5vw] top-1/2 -translate-y-1/2 z-[6]"
      >
      ...
      <div className="relative z-[6] h-full flex flex-col justify-center items-end text-right px-[6vw]">
        {/* Headline */}
        <div ref={headlineRef} className="mb-8">
          <h2 className="font-display font-bold text-[#F6F7F9] uppercase leading-[0.92] tracking-tight">
            <span className="headline-line block text-[clamp(2.5rem,7vw,6rem)]">Wired</span>
            <span className="headline-line block text-[clamp(2.5rem,7vw,6rem)]">To Last</span>
          </h2>
        </div>

        {/* Body */}
        <div ref={bodyRef} className="max-w-sm text-right">
          <p className="text-[#A9AFB8] text-base leading-relaxed mb-6">
            Neat routing, secure terminations, and code-compliant work—every time.
          </p>
          <button className="inline-flex items-center gap-2 font-mono text-sm text-[#F2C94C] hover:text-[#F5D76E] transition-colors group">
            See our standards
